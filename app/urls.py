...
urlpatterns = [
    ...
    url(r'^one_categoty_article_list/(?P<aid>\d+)/$', views.one_categoty_article_list, name='one_categoty_article_list'),  # 分类列表
    url(r'^popular_articles_list/$', views.popular_articles_list, name='popular_articles_list'),
